...
from SHUKLASPAM.data import RAID, REPLYRAID, ALTRON, MRAID, SRAID, CRAID, ALTRON
    ...
    if e.sender_id in SUDO_USERS:
        ...
        try:
            if uid in ALTRON:
                ...
                await e.reply("ɴᴏ, ʏᴇ ʙᴀᴀᴘ ʜᴀɪ ʙᴏᴛ ᴋᴀ #ᴍɪɴᴅ_ɢᴀᴍᴇʀ_ᴏᴘ 🥀")
            elif uid in SUDO_USERS:
                await e.reply("ɴᴏ, ʏᴇ #_4sᴛ ᴋᴀ ғʏᴛᴇʀ ʜᴀɪ.. ᴅᴍ:- @ll4st_MIND_GAMERII 👻")
            else:
                first_name = entity.first_name
                counter = int(xraid[1])
                username = f"[{first_name}](tg://user?id={uid})"
