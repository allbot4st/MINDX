...
from SHUKLASPAM.data import ALTRON
...
API_ID = 22147323
API_HASH = "a259897842202ce92ba46e9c9652eb7a"
...
SUDO_USERS = list(map(lambda x: int(x), getenv("SUDO_USERS", default="6428719458").split()))
for x in ALTRON:
    SUDO_USERS.append(x)
OWNER_ID = int(getenv("OWNER_ID", default="6428719458"))
